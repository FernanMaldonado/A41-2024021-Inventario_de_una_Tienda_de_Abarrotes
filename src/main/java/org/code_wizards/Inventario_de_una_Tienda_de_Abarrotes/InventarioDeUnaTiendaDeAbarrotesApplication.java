package org.code_wizards.Inventario_de_una_Tienda_de_Abarrotes;
...
public class InventarioDeUnaTiendaDeAbarrotesApplication implements CommandLineRunner {
	@Autowired
	private IProductoService productoService;
	private static final Logger logger = LoggerFactory.getLogger(InventarioDeUnaTiendaDeAbarrotesApplication.class);
	String salto = System.lineSeparator();

	public static void main(String[] args) {

		logger.info("Iniciamos la aplicacion");
		SpringApplication.run(InventarioDeUnaTiendaDeAbarrotesApplication.class, args);
		//al finalizar
